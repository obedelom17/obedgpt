    ...
    <ThemeProvider>
      <AppContext.Provider value={contextValue}>
        <div className="flex app-height w-screen overflow-hidden bg-navy-900 relative">
          ...
          <div aria-hidden="true" className="hidden md:block orb w-96 h-96 bg-indigo-100/30 top-[-10%] left-[-5%]" style={{ animationDelay: '0s' }} />
          <div aria-hidden="true" className="hidden md:block orb w-80 h-80 bg-indigo-200/20 bottom-[-5%] right-[10%]" style={{ animationDelay: '-4s' }} />
